...
$contains($brain, "foreach (['event_planning','host_command','event_results'", 'Agent opportunity queue must retain Playbook/Proposal, Host Command and post-event recommendation promotion while permitting additive intelligence streams');
