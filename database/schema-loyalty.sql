-- Group Loyalty + Membership Status canonical schema fragment.
-- Kept beside schema.sql so new-install schema maintenance and production migration stay explicit.
