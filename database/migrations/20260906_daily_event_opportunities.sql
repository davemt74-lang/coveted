-- Daily Events / partnered opportunity engine.
-- Existing installs: apply before deploying the matching PHP build.
...
CREATE TABLE IF NOT EXISTS daily_event_opportunities (
  ...
  KEY idx_daily_event_campaign (reward_campaign_id,event_id),
