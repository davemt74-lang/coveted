...
function coveted_member_sample_data(): array
{
    ...
    $groups = [
        ['id' => 'inner-circle', 'name' => 'The Inner Circle', 'members' => 28, 'next' => 'Saturday Night Supper Club', 'image' => '/assets/images/sample/groups/the-inner-circle.webp'],
        ['id' => 'city-table-club', 'name' => 'City Table Club', 'members' => 41, 'next' => 'Sunset Dinner', 'image' => '/assets/images/sample/groups/city-table-club.webp'],
        ['id' => 'late-night-listening', 'name' => 'Late Night Listening', 'members' => 33, 'next' => 'Vinyl & Cocktails', 'image' => '/assets/images/sample/groups/late-night-listening.webp'],
    ];
