(() => {
    ...
    (async () => {
        ...
        await loadScript('/assets/js/member-journeys-nav-v1.js?v=member-journeys-v1-20260907');
        ...
        await loadScript('/assets/js/partner-profile-nav-v1.js?v=partner-profile-crm-20260906');
