(() => {
    ...
    (async () => {
        ...
        await loadScript('/assets/js/admin-sidebar-accordion-v1.js?v=admin-sidebar-accordion-v1-20260905');
        ...
        await loadScript('/assets/js/admin-agent-v1.js?v=admin-agent-v1-nav-20260905');
