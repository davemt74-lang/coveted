...
coveted_page_start('Privacy Policy');
?>
<div class="cv-legal-page">
    <header class="cv-legal-page-head">
        <a class="cv-invite-request-back" href="/">← Coveted</a>
        <span class="cv-eyebrow">LEGAL</span>
        <h1>Privacy Policy</h1>
        <p>Effective September 5, 2026. This policy explains what Coveted collects, why we use it, and the choices available to you.</p>
    </header>
    ...
    <article class="cv-legal-document">
        ...
        <section>
            ...
            <p>Coveted may collect technical information needed to operate and secure the service, including device and browser information, timestamps, session information, security events, and a one-way hash derived from an IP address for abuse and rate-limit controls. If notifications are enabled, Coveted may also store device notification registration information.</p>
        </section>
        ...
        <section>
            ...
            <ul>
                ...
                <li>Protect Coveted against spam, abuse, fraud, and unauthorized access.</li>
                <li>Maintain operational records, audit trails, and service performance.</li>
            </ul>
        </section>
        ...
        <section>
            <h2>5. Social and website links</h2>
            <p>Links you submit are used to help Coveted review your request or member profile. Visiting a third-party website or social platform is governed by that third party’s own privacy practices. Coveted does not control those services.</p>
        </section>
        ...
        <section>
            <h2>7. Security</h2>
            <p>Coveted uses administrative, technical, and application-level safeguards intended to protect account and membership information. No online system can guarantee absolute security, so you should use a unique password and protect your account credentials.</p>
        </section>
        ...
        <section>
            ...
            <p>Coveted may update this policy as the service changes. The effective date at the top of this page will be updated when material changes are published.</p>
        </section>

        <section>
            <h2>10. Contact</h2>
            <p>For privacy questions or requests, contact Coveted using the support or contact method provided with your account, invitation, or official Coveted communication.</p>
        </section>
    </article>
</div>
